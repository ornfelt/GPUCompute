...
uniform sampler2D iChannel0; // for noise lookup (or other data)
uniform sampler2D iChannel1; // e.g. dither or additional data
uniform sampler2D iChannel2; // used in noise method 0
uniform vec3 iResolution;    // viewport resolution: (width, height, depth)
uniform float iTime;         // time in seconds
uniform vec4 iMouse;         // mouse: (current x, current y, click x, click y)

// Preprocessor definitions
#define LOOK 1           // 0: sunset look, 1: bright look
#define NOISE_METHOD 1   // 0, 1, or 2 (see code)
#define USE_LOD 1        // 0: no LOD, 1: yes LOD

// Helper: Camera setup function.
...
const int kDiv = 1; // higher quality with larger value
